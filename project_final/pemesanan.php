        ...
        <div class="card-body">
            <div class="row">
                <div class="col d-flex justify-content-end">
                    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#ModalTambahUser"> Tambah Pesanan</button>
                </div>
            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="floatingInput" name="kode_pesanan" value="<?php echo date('dHi') . rand(100, 999) ?>" readonly>
                ...
                <div class="modal-dialog modal-md modal-fullscreen-md-down">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary" name="edit_pesanan_validate" value="12345">Save</button>
                        </div>
                        </form>
                    </div>
                </div>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo (!empty($row['id_pesan'])) ? "<span class='badge text-bg-success'>Dipesan</span>" : "" ; ?>
                                <td class="d-flex">
                                    ...
                                    <button class="<?php echo (!empty($row['id_pesan'])) ? "btn btn-secondary btn-sm me-1 disabled" : "btn btn-warning btn-sm me-1"; ?>" data-bs-toggle="modal" data-bs-target="#ModalEdit<?php echo $row['id_pesanan'] ?>"><i class="bi bi-pencil-square"></i></i></button>
